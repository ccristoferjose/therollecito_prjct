...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    //
    // Scoped to non-production for the same reason as the localhost patterns:
    // production serves images from S3/CloudFront and must keep the SSRF
    // protection on. See the Next 16 upgrade guide, "Local IP Restriction".
