...
CREATE TABLE promotion (
  ...
  max_uses       INT UNSIGNED    NULL COMMENT 'optional global cap across all customers (NULL = unlimited)',
  per_user_limit INT UNSIGNED    NULL COMMENT 'max redemptions per registered customer (NULL = unlimited)',
